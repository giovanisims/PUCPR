public class Main {
    public static void main(String[] args) {
        ...
        System.out.printf("Genêro: %s | Ano: %s | Nome: %s | Artista(s): %s %n%n", album.genre, album.year, album.name, album.artist);
...
class Music {
    ...
    String playMusic() {
        return String.format("Título: %s | Duração: %s", title, length);
    }
}